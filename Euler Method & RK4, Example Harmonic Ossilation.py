# -*- coding: utf-8 -*-
"""
Created on Mon Jan 15 23:59:29 2024
...
# Plot the results
plt.plot(t, euler_sol[0], label='Euler Displacement', linestyle='--')
#plt.plot(t, euler_sol[1], label='Euler Velocity', linestyle='--')
plt.plot(t, rk4_sol[0], label='RK4 Displacement')
#plt.plot(t, rk4_sol[1], label='RK4 Velocity')
plt.plot(t,SHO_Sol[0], label='Exact Displacement', linestyle='--')
